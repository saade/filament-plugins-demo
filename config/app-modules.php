...
return [
    ...
    */
    ...
    'stubs' => [
        ...
        'resources/views/.gitkeep' => base_path('stubs/app-modules/.gitkeep'),
        // 'resources/css/filament/theme.css' => base_path('stubs/app-modules/resources/css/filament/theme.css'),
        'src/Filament/StubClassNamePrefixPlugin.php' => base_path('stubs/app-modules/src/Filament/Plugin.php'),
        'src/Models/.gitkeep' => base_path('stubs/app-modules/.gitkeep'),
        'src/Providers/StubClassNamePrefixServiceProvider.php' => base_path('stubs/app-modules/src/Providers/ServiceProvider.php'),
        'src/Providers/StubClassNamePrefixPanelProvider.php' => base_path('stubs/app-modules/src/Providers/PanelProvider.php'),
